...
function sched_ReconcileAccrualJE(type) {
	try
	{
		...
		//by gowthaman
		var data = '';
		var rowno = new Array(),csvFolderId ='424999', errorExists = false;
		// prod folder id = 424999 ,sb =386363
		  
		rowno[0] = 'Purchase Order internalid';
		...
		{ 
			if(errorExists)
				{
		var newFile = nlapiCreateFile('inconsistent_recon_bill_'+new Date()+'_.csv', 'CSV', data); 
