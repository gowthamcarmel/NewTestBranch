...
{	
	try
	{
		...
		var arrVendorTransactionsDetail = getTransactionsToApply(stSubsidiary, stCurrency, stSrcTranPeriodEnd, stVendor, stVendorTransDetailSearch);
 ...
 * @returns
 */
function getTransactionsToApply(stSubsidiary, stCurrency, stSrcTranPeriodEnd, stVendor, stVendorTransDetailSearch)
{
    var arrFilters = [new nlobjSearchFilter('subsidiary', null, 'anyof', stSubsidiary),
                      new nlobjSearchFilter('trandate', null, 'onorbefore', stSrcTranPeriodEnd),
                      new nlobjSearchFilter('entity', null, 'anyof', stVendor),
