...
function workflowAction_enterRejectReason()
{
    ...
    {    	
		...
		nlapiSetRedirectURL('SUITELET','customscript_pr_rejected_reason_sui','customdeploy_pr_rejected_reason_sui', null, arrParams);
...
function updateRejectReason(request, response, form, stTranId, stTranType)
{
	...
	nlapiSubmitField(stTranType, stTranId, ['custrecord_pr_rejectedreason','custrecord_pr_approvalstatus'], 
			[stRejectReasonDetails,'4']);
