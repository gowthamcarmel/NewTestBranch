...
function workflowAction_enterRejectReason()
{
    ...
    {    	
    	...
    	nlapiSetRedirectURL('SUITELET','customscript_aap_rej_reas_update_s','customdeploy_access_automation_rejection', null, arrParams);
...
function updateRejectReason(request, response, form, stTranId, stTranType)
{
	...
	nlapiSubmitField(stTranType, stTranId, ['custrecord_urr_rej_details', 'custrecord_urr_app_status'], 
